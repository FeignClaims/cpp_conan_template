...
macro(fetch_project_options git_repository git_tag)
  ...
  FetchContent_Declare(_replace_this_project_options
    GIT_REPOSITORY ${git_repository}
    GIT_TAG ${git_tag}
    GIT_SHALLOW true
  )
  FetchContent_MakeAvailable(_replace_this_project_options)
  include(${_replace_this_project_options_SOURCE_DIR}/Index.cmake)
  include(${_replace_this_project_options_SOURCE_DIR}/src/DynamicProjectOptions.cmake)
endmacro()
